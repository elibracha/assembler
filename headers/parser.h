...
unsigned int build_data(char*, char *, char **, int, int);

void mov_handler(char*, char *, char **, int, int);

void cmp_handler(char*, char *, char **, int, int);

void add_handler(char*, char *, char **, int, int);

void sub_handler(char*, char *, char **, int, int);

void lea_handler(char*, char *, char **, int, int);

void not_handler(char*, char *, char **, int, int);

void clr_handler(char*, char *, char **, int, int);

void inc_handler(char*, char *, char **, int, int);

void dec_handler(char*, char *, char **, int, int);

void jmp_handler(char*, char *, char **, int, int);

void bne_handler(char*, char *, char **, int, int);

void red_handler(char*, char *, char **, int, int);

void prn_handler(char*, char *, char **, int, int);

void jsr_handler(char*, char *, char **, int, int);

void rts_handler(char*, char *, char **, int, int);
